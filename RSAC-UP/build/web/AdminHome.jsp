    ...
    <head>
        ...
        <style>
            ...
            .bg-image {
                ...
                width: 100%;
                color: white;
                background-image: url('remote-sensing.jpg');
...
<section class="container menuitem">
    <div class="row">
        ...
        %>
        <div class="col-3" style="padding-left:100px;color:white;"><h1>Hello <%=user%></h1></div>
...
<section id="main-content">
    <div class="bg-image">
        <br><center><h1>Admin Page</h1></center><br><br>
        <div>
            <center>
                <ul>
                    <li class="b0"><a href="userReg.jsp" title="Add User" >Add User</a></li><br>
                    <li class="b0"><a href="userSearch.jsp" title="Search User" >Search User</a></li><br>
                    <li class="b0"><a href="userEdit.jsp" title="Edit User" >Edit User</a></li><br>
                    <li class="b0"><a href="userDelete.jsp" title="Delete User">Delete User</a></li>
               </ul>
            </center>
        </div>
    </div>
