<%-- 
    Document   : replyPage
    Created on : Mar 17, 2023, 1:44:53 PM
    Author     : india
--%>
...
<section id="main-content">
    <div class="bg-image">
        <br><center><h1>Reply Page</h1></center><br><br>
        <div class="login">
            <center>
                <form action="loginConf" method="post">
                    <table class="table table1">
                        <tr><td><h1>User Query from Ref.NO. 1 <%=request.getParameter("refNo")%></h1></td></tr> 
                        <tr><td>User Msg <%=request.getParameter("sub")%></td></tr> 
                        <tr><td><h1>Reply to <%=request.getParameter("email")%></h1></td></tr> 
                        <tr><td>Subject</td></tr> 
                        <tr><td><input type="text" name="sub" value="" class="form-control"></td></tr>
                        <tr><td>Message</td></tr> 
                        <tr><td><textarea name="msg" class="form-control"></textarea></td></tr> 
