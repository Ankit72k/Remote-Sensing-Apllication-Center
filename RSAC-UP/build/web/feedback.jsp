<%-- 
    Document   : feedback
    Created on : Mar 5, 2023, 11:38:09 AM
    Author     : india
--%>
...
<section id="main-content">
    <div class="bg-image">
        <br><center><h1><u>FeedBack Form</u></h1></center><br><br>
        <div class="login">
            <center>
                <form action="feedConf" method="post">
                    <table class=" table1">
                        <tr>
                            <td><input type="text" name="name" placeholder="Name" class="border form-control" >
                            </td>
                        </tr>
                        <tr>
                            <td><input type="text" name="email" placeholder="Email" class="border form-control" >
                            </td>
                        </tr>
                        <tr>
                            <td><input type="text" name="sub" placeholder="Subject" class="border form-control" >
                            </td>
                        </tr>                        
                        <tr>
                            <td><textarea name="message" class="border form-control" placeholder="Message"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td><input class="btn-danger form-control border" type="submit" value="Submit"></td>
                        </tr>
                    </table>
                </form>
            </center>
